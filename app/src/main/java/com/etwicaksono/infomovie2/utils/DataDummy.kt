...
object DataDummy {
    ...
    fun getAllMoviesResponse(): List<ResponseMovieItem> {
        val movies = ArrayList<ResponseMovieItem>()
    ...
    fun getAllTvShowsResponse(): List<ResponseTvShowItem> {
        val series = ArrayList<ResponseTvShowItem>()
    ...
    fun getMovieResponse(): ResponseDetailMovie {
        val genres = ArrayList<Genre>()
        genres.add(Genre(28, "Action"))
        genres.add(Genre(12, "Adventure"))
        genres.add(Genre(14, "Fantasy"))
        genres.add(Genre(878, "Science Fiction"))
    ...
    fun getTvShowResponse(): ResponseDetailTv {
        val genres = ArrayList<Genre>()

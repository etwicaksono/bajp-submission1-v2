...
class DetailViewModelTest {
    ...
    private var dummyMovie = DataDummy.getAllMovies()[0]
    private var dummyTvShow = DataDummy.getAllTvShows()[0]
    ...
    @Test
    fun getMovieTest() {
        viewModel.setSelectedItem("movies", movieId)
        viewModel.getItem()
    ...
    @Test
    fun getTvShowTest() {
        viewModel.setSelectedItem("series", tvShowId)
        viewModel.getItem()
        val movie = viewModel.item
        Assert.assertNotNull(movie)
